package com.linekong.game.activity.utils.cache;
...
public class GuavaUtil {
    @Autowired
    private GuavaCacheDao guavaCacheDao;
    ...
    public static List<ItemInfoPO> getItemInfo(String activityType) {
        ...
        try {
            ...
            LoggerUtil.error(GuavaUtil.class, "param="+activityType+",error info:"+e.toString());
        }
        return null;
    }
    //根据活动key查询物品缓存
