package com.linekong.report.reyun.util.log;
...
public class LoggerAOPUtils {
	...
	@Before("execution(* *com.linekong.report.reyun.service.impl..*.*(..))")
	 ...
	 * 触发调用方法
	 */
	@Around("execution(* *com.linekong.report.reyun.service.impl..*.*(..))")
	public Object doCallMethod(ProceedingJoinPoint pjp){
		...
		buffer.append("],timeMillis=").append(System.currentTimeMillis()-beginTime).append(",");
