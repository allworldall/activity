...
public class RedisClientTemplate {
	 ...
	 *            ... keys
	 */
	public void remove(final String... keys) throws RedisException{
		for (String key : keys) {
			remove(key);
		}
	}
	...
	public void removePattern(final String pattern) throws RedisException{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void remove(final String key) throws RedisException{
		if (exists(key)) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void set(final String key, Object value) throws RedisException {
		ValueOperations<Serializable, Object> operations = this.redisTemplate.opsForValue();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void set(final String key, Object value, Long expireTime) throws RedisException{
		ValueOperations<Serializable, Object> operations = this.redisTemplate.opsForValue();
		operations.set(key, value);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void hmset(String key, Map<String, String> value) throws RedisException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public long incr(String key, long increment) throws RedisException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public long setList(String key, Object value) throws RedisException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void setExpire(String key,long timeout) throws RedisException{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public long addSet(String key,Object value) throws RedisException{
	 ...
	 */
	@SuppressWarnings("unchecked")
	public int getSet(String key) throws RedisException{
