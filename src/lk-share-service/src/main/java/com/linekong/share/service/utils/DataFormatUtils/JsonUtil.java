package com.linekong.share.service.utils.DataFormatUtils;
...
public final class JsonUtil {
   ...
   public static String convertBeanToJson(Object obj){
    ...
    public static String convertBeanToJson1(Object obj){
        return obj == null ? null : new GsonBuilder().disableHtmlEscaping().create().toJson(obj);
    }
   /**
    * gson进行json转换对象
    * @param String json
